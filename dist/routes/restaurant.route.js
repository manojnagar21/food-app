...
router.route("/").post(isAuthenticated_1.isAuthenticated, multer_1.default.single("imageFile"), (0, validateRequest_1.validateRequest)(restaurantValidation_1.createRestaurantSchema), restaurant_controller_1.createRestaurant);
router.route("/").get(isAuthenticated_1.isAuthenticated, restaurant_controller_1.getRestaurant);
router.route("/").put(isAuthenticated_1.isAuthenticated, multer_1.default.single("imageFile"), (0, validateRequest_1.validateRequest)(restaurantValidation_1.updateRestaurantSchema), restaurant_controller_1.updateRestaurant);
router.route("/order").get(isAuthenticated_1.isAuthenticated, restaurant_controller_1.getRestaurantOrders);

    ...
    useEffect(() => {
        const fetchRestaurant = async () => {
            ...
            setInput({
                ...
                deliveryTime: restaurant?.deliveryTime ? Number(restaurant.deliveryTime) : 0,
                ...
                <div>
                    ...
                    <form onSubmit={submitHandler}>
                        <div className="md:grid grid-cols-2 gap-6 space-y-2 md:space-y-0">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    placeholder="Enter your cuisines e.g Roti,Sabji,Dal" 
                                />
                        ...
                        <div className="my-5 w-fit">
                            {
                                loading ? (
                                    <Button disabled className="bg-orange hover:bg-hoverOrange">Please Wait<Loader2 className="mr-2 w-4 h-4 animate-spin"></Loader2></Button>
                                ) : (

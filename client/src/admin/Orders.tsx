...
const Orders = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto py-10 px-6">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-10">Order Overview</h1>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start sm:items-center bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 sm:p-8 border-gray-200 dark:border-gray-700">
                            ...
                            <div className="w-full sm:w-1/3">
                                ...
                                <Select onValueChange={(newStatus) => handleStatusChange(order._id, newStatus)} defaultValue={order.status}>
                                    <SelectTrigger className="w-full rounded-md border border-gray-300 px-4 py-2 text-sm shadow-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-orange-500">
